...
import { Phone, Star, ShieldCheck, Clock, ArrowRight, Wrench, Plus } from "lucide-react";
...
const faqs = [
  {
    question: "Dans quel délai intervenez-vous pour un dépannage plomberie à Cagnes-sur-Mer ?",
    answer:
      "J'interviens le plus rapidement possible selon ma disponibilité et votre localisation. Pour les urgences à Cagnes-sur-Mer et dans les communes proches, j'essaie de me déplacer dans la journée. Appelez le 07 69 05 08 32 pour évaluer ensemble l'urgence.",
  },
  {
    question: "Le devis de dépannage est-il gratuit ?",
    answer:
      "Oui, le devis est toujours gratuit et sans engagement. Avant toute intervention, je vous remets un devis clair et détaillé pour que vous sachiez exactement ce que vous payez.",
  },
  {
    question: "Quels types de dépannages plomberie prenez-vous en charge ?",
    answer:
      "Je prends en charge tous les dépannages courants : fuites d'eau, canalisations cassées, robinets défectueux, dégâts des eaux, problèmes de pression, fuites sous évier, et bien plus.",
  },
  {
    question: "Intervenez-vous le week-end pour un dépannage ?",
    answer:
      "J'interviens du lundi au samedi de 8h à 19h. Pour toute urgence, n'hésitez pas à m'appeler ou m'envoyer un message WhatsApp pour vérifier ma disponibilité.",
  },
  {
    question: "Quelles communes couvrez-vous pour le dépannage plomberie ?",
    answer:
      "J'interviens à Cagnes-sur-Mer et dans tout le 06 : Antibes, Nice, Saint-Laurent-du-Var, Vence, Cannes, Mougins, Biot, La Colle-sur-Loup et alentours.",
  },
];

export default function DepannagePlomberiePage() {
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
            <motion.div variants={fadeUp}>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-navy-100 backdrop-blur">
                ...
                Dépannage plomberie · Cagnes-sur-Mer & 06
              </span>
            </motion.div>
            ...
            >
              Fuite d'eau, canalisation cassée, dégât des eaux : LP Plomberie intervient rapidement à Cagnes-sur-Mer et dans tout le 06. Diagnostic précis, réparation durable, devis gratuit.
            </motion.p>
        ...
        <div className="container-x">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold text-navy-900 sm:text-4xl">
              Dépannage plomberie — vos questions
            </h2>
          </div>
