...
const faqs = [
  {
    question: "Intervenez-vous à Vence pour les urgences plomberie ?",
    answer: "Oui, j'interviens à Vence et Saint-Paul-de-Vence pour tous vos dépannages plomberie. Appelez le 07 69 05 08 32 pour une intervention rapide.",
  },
  {
    question: "Quel est le délai d'intervention à Vence ?",
    answer: "Basé à Cagnes-sur-Mer, j'interviens rapidement à Vence. Pour les urgences, j'essaie de me déplacer dans la journée selon ma disponibilité.",
  },
  {
    question: "Réalisez-vous des rénovations de salle de bain à Vence ?",
    answer: "Oui, je réalise des rénovations complètes de salle de bain à Vence : douche à l'italienne, baignoire, lavabo, robinetterie. Devis gratuit sur place.",
  },
  {
    question: "Le devis est-il gratuit pour une intervention à Vence ?",
    answer: "Oui, le devis est toujours gratuit et sans engagement, que ce soit pour un dépannage ou un projet de rénovation à Vence.",
  },
];

export default function PlombierVencePage() {
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
            <motion.div variants={fadeUp}>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-navy-100 backdrop-blur">
                ...
                Plombier · Vence & Saint-Paul-de-Vence
              </span>
            </motion.div>
            <motion.h1 variants={fadeUp} className="mt-6 font-display text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
              Plombier à{" "}
              <span className="bg-gradient-to-r from-navy-100 to-white bg-clip-text text-transparent">Vence</span>
            </motion.h1>
            <motion.p variants={fadeUp} className="mt-6 max-w-xl text-base leading-relaxed text-navy-100/85 sm:text-lg">
              LP Plomberie intervient à Vence et Saint-Paul-de-Vence pour tous vos travaux de plomberie : dépannage rapide, recherche de fuite, débouchage, chauffe-eau et rénovation de salle de bain. Devis gratuit, travail soigné.
            </motion.p>
        ...
        <div className="container-x">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold text-navy-900 sm:text-4xl">
              Tous vos besoins plomberie à Vence
            </h2>
            <p className="mt-4 text-navy-600">
              LP Plomberie prend en charge l'ensemble de vos travaux de plomberie à Vence et ses environs.
            </p>
          </div>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="container-x">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold text-navy-900 sm:text-4xl">Plombier à Vence — vos questions</h2>
          </div>
